...
export const SECTORS: Array<{
...
}> = [
  {
    ...
    shortLabel: "Art",
    pageName: "Art",
    sectionTint: "bg-[#93B7C8]",
    surfaceTint: "bg-[#EADCC3]",
    cardTint: "bg-[#F5EEE1]",
    mediaTint: "bg-[#1F6B6D]",
    borderTone: "border-[#1F6B6D]/30",
    textTone: "text-[#1F6B6D]",
    buttonTone: "bg-[#1F6B6D] text-white",
    mutedTone: "text-[#355f61]/78",
    shellTint: "bg-[#F5EEE1]/88",
  },
  {
    id: "music",
    shortLabel: "DJ",
    pageName: "DJ",
    sectionTint: "bg-[#E8D6B3]",
    surfaceTint: "bg-[#93B7C8]",
    cardTint: "bg-[#F8EEDB]",
    mediaTint: "bg-[#D04A34]",
    borderTone: "border-[#D04A34]/26",
    textTone: "text-[#7D2D20]",
    buttonTone: "bg-[#D04A34] text-white",
    mutedTone: "text-[#7D2D20]/76",
    shellTint: "bg-[#F8EEDB]/88",
  },
  {
    id: "fashion",
    shortLabel: "Fashion",
    pageName: "Fashion",
    sectionTint: "bg-[#D04A34]",
    surfaceTint: "bg-[#EADCC3]",
    cardTint: "bg-[#F3D8D2]",
    mediaTint: "bg-[#1F6B6D]",
    borderTone: "border-[#F5EEE1]/42",
    textTone: "text-[#F8F1E4]",
    buttonTone: "bg-[#1F6B6D] text-white",
    mutedTone: "text-[#F8EEDB]/88",
    shellTint: "bg-[#F3D8D2]/90",
  },
];
